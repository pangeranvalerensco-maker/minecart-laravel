...
<main class="main-content" style="background-color: var(--body-bg); padding: 40px 0;">
    <div class="container" style="max-width: 900px;">
        ...
        <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 30px;">
            ...
            <h1 class="page-title" style="margin: 0; font-size: 1.8rem; font-weight: 700;">Tambah Produk Baru</h1>
        </div>
        ...
        <form action="{{ route('seller.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="background: var(--card-bg); padding: 30px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.03); border: 1px solid var(--subtle-border-color); margin-bottom: 25px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    <div class="form-group" style="margin: 0;">
                        ...
                        <input type="text" id="title_id" name="title_id" class="form-control" placeholder="Contoh: Kaus Katun Premium" required style="border-radius: 8px; border: 1px solid var(--subtle-border-color); background: var(--body-bg); color: var(--text-color); padding: 12px;">
                    ...
                    <div class="form-group" style="margin: 0;">
                        ...
                        <input type="text" id="title_en" name="title_en" class="form-control" placeholder="Example: Premium Cotton T-Shirt" required style="border-radius: 8px; border: 1px solid var(--subtle-border-color); background: var(--body-bg); color: var(--text-color); padding: 12px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div class="form-group" style="margin: 0;">
                        ...
                        <textarea id="description_id" name="description_id" class="form-control" rows="5" placeholder="Tuliskan deksripsi lengkap produk Anda..." required style="border-radius: 8px; border: 1px solid var(--subtle-border-color); background: var(--body-bg); color: var(--text-color); padding: 12px; resize: vertical;"></textarea>
                    ...
                    <div class="form-group" style="margin: 0;">
                        ...
                        <textarea id="description_en" name="description_en" class="form-control" rows="5" placeholder="Write full product description..." required style="border-radius: 8px; border: 1px solid var(--subtle-border-color); background: var(--body-bg); color: var(--text-color); padding: 12px; resize: vertical;"></textarea>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px; margin-top: 20px;">
                    ...
                    <div class="form-group" style="margin: 0;">
                        ...
                        <input type="number" id="weight" name="weight" class="form-control" placeholder="1000" min="1" value="1000" required style="border-radius: 8px; border: 1px solid var(--subtle-border-color); background: var(--body-bg); color: var(--text-color); padding: 12px;">
                    ...
                    <div class="form-group" style="margin: 0;">
                        ...
                        <input type="text" id="sku" name="sku" class="form-control" placeholder="Kode Barang" style="border-radius: 8px; border: 1px solid var(--subtle-border-color); background: var(--body-bg); color: var(--text-color); padding: 12px;">
            ...
            <div style="background: var(--card-bg); padding: 30px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.03); border: 1px solid var(--subtle-border-color); margin-bottom: 25px;">
                ...
                <div class="form-group" style="margin: 0;">
                    <label for="image" style="font-weight: 600; font-size: 0.9rem; margin-bottom: 10px; display: block;">Foto Produk Utama <span style="color: #e63946;">*</span></label>
                    <div style="border: 2px dashed #cbd5e1; border-radius: 12px; padding: 40px; text-align: center; background: var(--body-bg); cursor: pointer; transition: background 0.2s; position: relative; min-height: 250px; display: flex; flex-direction: column; justify-content: center; align-items: center;" id="image-dropzone" onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='#f8fafc'">
                        <div style="font-size: 2rem; color: var(--text-color); margin-bottom: 10px;" id="image-icon">📸</div>
                        <p style="margin: 0; font-size: 0.95rem; font-weight: 500; color: var(--heading-color);" id="image-text">Klik atau Seret foto ke sini</p>
                        <p style="margin: 5px 0 0 0; font-size: 0.8rem; color: var(--text-color);" id="image-subtext">Format: JPG, PNG, WEBP. Maks 2MB.</p>
                        <input type="file" id="image" name="images[]" multiple accept="image/*" required style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; opacity: 0; cursor: pointer;" onchange="previewImage(this)">
                    </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div class="form-group" style="margin: 0; position: relative;">
                        ...
                        <div style="position: relative;">
                            ...
                            <input type="number" id="price" name="price" class="form-control" placeholder="0" min="0" required style="border-radius: 8px; border: 1px solid var(--subtle-border-color); background: var(--body-bg); color: var(--text-color); padding: 12px 12px 12px 45px; width: 100%;">
                        </div>
                    ...
                    <div class="form-group" style="margin: 0;">
                        ...
                        <input type="number" id="stock" name="stock" class="form-control" placeholder="0" min="0" required style="border-radius: 8px; border: 1px solid var(--subtle-border-color); background: var(--body-bg); color: var(--text-color); padding: 12px;">
            ...
            <div style="display: flex; justify-content: flex-end; gap: 15px; padding-bottom: 50px;">
                ...
                <button type="submit" class="cta-button" style="padding: 14px 35px; border-radius: 8px; font-weight: 600; box-shadow: 0 4px 12px rgba(61, 206, 196, 0.3);">Simpan Produk</button>
            </div>
        </form>
